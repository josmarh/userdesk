                ...
                <div class="col-lg-5 col-md-8">
                    <div class="card" style="transform: translate(0px, 25px);">
                        <div class="card-header">
                            <router-link :to="{name: 'Signin'}" class="navbar-brand d-flex align-items-center">
                                <!--Logo start-->
                        ...
                        <div class="card-body">
                            ...
                            <form @submit.prevent="signin">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="email" v-model="model.email" aria-describedby="email" placeholder="Email address" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="password" class="form-control" id="password" v-model="model.password" aria-describedby="password" placeholder="Password" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 d-flex justify-content-between mb-3">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="customCheck1" v-model="model.remember">
                                ...
                                <button type="submit" class="btn btn-primary text-white w-100" :disabled="isDisabled">
                                    Sign in
                                </button>
                    ...
                    <div class="auth-img">
                        <img src="/images/auth/01.png" alt="page" class="signin-outer-img w-25">
                        <img src="/images/auth/02.png" alt="robot" class="signin-robot-img w-25">
                    </div>
                </div>
            </div>
        </div>
